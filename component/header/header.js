...
<style>
    ...
    header .container .header_nav a::after {
        content: "";
        position: absolute;
        left: 50%;
        right: 50%;
    ...
    header .container .header_nav a:hover::after {
        left: 0;
        right: 0;
    }
    ...
    header .container #tools #search_bar {
        display: flex;
        position: relative;
        height: 70%;
        margin: auto;
    ...
    header .container #tools #search_bar button:focus {
        outline: none;
    }
...
class CPT_Header extends HTMLElement
{
    constructor()
    {
        super();
        ...
        this._shadowRoot.appendChild(header_template.content.cloneNode(true));
    }
...
customElements.define("cpt-header", CPT_Header);